...
gpu_num = None                                                 # set the GPU number of your server.
...
wandb_proj = 'parking'  #mlstgcn-master
...
if config['data']['type'] == 'pm25':
    root_dir = 'data'
    pm25_data_dir = os.path.join(root_dir, 'temporal_data/metr-la')
    pm25_graph_dir = os.path.join(root_dir, 'graph/four graph')
else:
